...
```bash
npx skills add yxdwind/how-to-research -g
```
...
```powershell
# Windows PowerShell
irm https://raw.githubusercontent.com/yxdwind/how-to-research/main/install.ps1 | iex
```

```bash
# macOS / Linux
curl -fsSL https://raw.githubusercontent.com/yxdwind/how-to-research/main/install.sh | bash
```

**方式三 · 手动**

```bash
git clone https://github.com/yxdwind/how-to-research.git
# 把仓库目录（含 SKILL.md）复制到你的 AI 技能目录，
# 如 ~/.agents/skills/how-to-research 或 ~/.claude/skills/how-to-research
```

更新已装的 skill：`npx skills update how-to-research`，或重跑安装脚本（加 -Force/--force 覆盖）。
...
- 直接说"用怎样调研这个 skill 做一次竞品调研"→ 加载核心框架
